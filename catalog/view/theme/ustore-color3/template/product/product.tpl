...
<div class="right">
  ...
  <div id="tab-information" class="tab-content">
   <div class="description">
      ...
      <?php if ($review_status) { ?>
      <div class="review">
        <div><img src="catalog/view/theme/ustore-color1/image/stars-<?php echo $rating; ?>.png" alt="<?php echo $reviews; ?>" />
      ...
      <div class="cart">
        ...
        <div><a class="wish-list" title="<?php echo $button_wishlist; ?>" onclick="addToWishList('<?php echo $product_id; ?>');"><span><?php echo $button_wishlist; ?></span></a>&nbsp;
          <a class="compare-icon" title="<?php echo $button_compare; ?>" onclick="addToCompare('<?php echo $product_id; ?>');"><span><?php echo $button_compare; ?></span></a></div>
        <?php if ($minimum > 1) { ?>
...
<div class="box">
  ...
  <div class="box-product">
      ...
      <div>
        ...
        <div class="imag"><a href="<?php echo $product['href']; ?>"><img src="<?php echo $product['thumb']; ?>" alt="<?php echo $product['name']; ?>" /></a></div>
        <?php } ?>
        ...
        <?php } ?>-->
        <!--<a onclick="addToCart('<?php echo $product['product_id']; ?>');" class="button2"><span><?php echo $button_cart; ?></span></a>-->
        </div>
      <?php } ?>
    </div>
