...
<div id="clipart_list_dialog"  style="display:none">
	<form id="clipart_list_form" method="post" enctype="application/x-www-form-urlencoded">
		...
		<?php if ($categories) { ?>
			<label class="is_ml" ml_label="clipart_text_categories"><?php echo $clipart_text_categories; ?></label>
		...
		<td width="50%" align="right"><label class="is_ml" ml_label="clipart_text_search"><?php echo $clipart_text_search; ?></label> <input type="text" name="clipart_keyword" id="clipart_keyword" style="width:300px;" value="<?php echo $clipart_keyword; ?>" class="ui-corner-all ui-widget-content" >
		</td>
	      </tr>
	    </table>
	</form>
