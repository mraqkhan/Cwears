...
<div id="product_list_dialog"  style="display:none">
	<form id="product_list_form" method="post" enctype="application/x-www-form-urlencoded">
		...
		<?php if ($categories) { ?>
			<label class="is_ml" ml_label="product_text_categories"><?php echo $product_text_categories; ?></label>
		...
		<td width="50%" align="right"><label class="is_ml" ml_label="product_text_search"><?php echo $product_text_search; ?></label> <input type="text" name="product_keyword" id="product_keyword" style="width:300px;" value="<?php echo $product_keyword; ?>" class="ui-corner-all ui-widget-content" >
		</td>
	      </tr>
	    </table>
	</form>
