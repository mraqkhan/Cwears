...
<div id="template_list_dialog"  style="display:none">
	<form id="template_list_form" method="post" enctype="application/x-www-form-urlencoded">
		...
		<?php if ($categories) { ?>
			<label class="is_ml" ml_label="template_text_categories"><?php echo $template_text_categories; ?></label>
		...
		<td width="50%" align="right"><label class="is_ml" ml_label="template_text_search"><?php echo $template_text_search; ?></label> <input type="text" name="template_keyword" id="template_keyword" style="width:300px;" value="<?php echo $template_keyword; ?>" class="ui-corner-all ui-widget-content" >
		</td>
	      </tr>
	    </table>
	</form>
