			...
			if($compositions) {
				foreach ($compositions as $value) {
					...
					foreach ($results as $result) {
						...
						if (file_exists(DIR_IMAGE . 'data/designs/design_' . $result['id_design']. '/snapshot.png')) {
							$image['original'] = HTTPS_IMAGE . 'data/designs/design_' . $result['id_design']. '/snapshot.png';
						} else {
							$image['original'] = '';
						}

						if (file_exists(DIR_IMAGE . 'data/designs/design_' . $result['id_design']. '/design_image.png')) {
							$image['png'] = HTTPS_IMAGE . 'data/designs/design_' . $result['id_design']. '/design_image.png';
						} else {
							$image['png'] = '';
						}
