<div id="view_<?php echo $view_index; ?>" class="ui-widget-content" style="overflow:auto; margin:5px; padding:5px; border-width:3px;">
	...
	<div style="float:left">
		<table cellpadding="3" cellspacing="2" border="0">
			...
			<tr>
				<td class="ui-widget-content"><?php echo $text_shade; ?>
				...
				<table>
					<tr>
						...
						<td><input id="shade_upload_<?php echo $view_index; ?>" type="file" />
							<!--<a onclick="$('#thumb_shade_<?php echo $view_index; ?>').attr('src', '<?php echo $no_image; ?>'); $('input[name=\'views[<?php echo $view_index; ?>][shade]\']').attr('value', '');">
								<?php echo $text_clear; ?>
							</a>--></td>
					</tr>
				</table>
			...
			<tr>
				<td class="ui-widget-content"><?php echo $text_scale; ?><span id="span_scale_<?php echo $view_index; ?>"><?php echo $regions_scale; ?></span></td>
			</tr>
			<tr>
				<td class="ui-widget-content"><?php echo $text_fills; ?>
					<ul class="fill_container" view_index="<?php echo $view_index; ?>" id="fills_<?php echo $view_index; ?>">
			...
			<tr>
				<td class="ui-widget-content"><?php echo $text_regions; ?><span style="float:right; display:none;" id="button_add_region_<?php echo $view_index; ?>" onclick="addRegion(<?php echo $view_index; ?>)"><img src="view/image/add.png" /><a style="vertical-align:top;"><?php echo $button_add_region; ?></a></span>
					<hr />
...
$(document).ready(function() {
	...
	var attributes = {};
	swfobject.embedSWF("view/template/product/drawer.swf", "view_drawer_<?php echo $view_index; ?>", "403", "403", "10.0.0", '', flashvars, params, attributes);    
