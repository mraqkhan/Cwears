...
class ModelProductColor extends Model {
	...
	{
		$sql = "SELECT * ";
		$tables = "FROM " . DB_PREFIX . "printable_product_color pc, " . DB_PREFIX . "printable_product_color_flat_color fc "; 
		$condition = " WHERE pc.deleted=0 AND fc.id_product_color=pc.id_product_color  ";
